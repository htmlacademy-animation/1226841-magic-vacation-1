...
/***/ "./source/js/modules/animation/anim.js":
/*!*********************************************!*\
  !*** ./source/js/modules/animation/anim.js ***!
  \*********************************************/
/*! exports provided: animChangeScreen, animHiddenScreen */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animChangeScreen", function() { return animChangeScreen; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animHiddenScreen", function() { return animHiddenScreen; });
/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../dom */ "./source/js/dom.js");
/* harmony import */ var _screenNames__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../screenNames */ "./source/js/screenNames.js");
/* harmony import */ var _animCanvas_SceneSeaCalf__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./animCanvas/SceneSeaCalf */ "./source/js/modules/animation/animCanvas/SceneSeaCalf.js");
/* harmony import */ var _animCanvas_SceneCrocodile__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./animCanvas/SceneCrocodile */ "./source/js/modules/animation/animCanvas/SceneCrocodile.js");
/* harmony import */ var _animScreenResult__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./animScreenResult */ "./source/js/modules/animation/animScreenResult.js");
/* harmony import */ var _animScreenTop__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./animScreenTop */ "./source/js/modules/animation/animScreenTop.js");
/* harmony import */ var _animScreenPrizes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./animScreenPrizes */ "./source/js/modules/animation/animScreenPrizes.js");
/* harmony import */ var _animScreenGame__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./animScreenGame */ "./source/js/modules/animation/animScreenGame.js");
/* harmony import */ var _animScreenStoty__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./animScreenStoty */ "./source/js/modules/animation/animScreenStoty.js");
...
const animChangeScreen = () => {
  let handlers = {
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["TOP"]}`]: (el) => {
      Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl(`.intro__message`).addClass(`intro__message--anim`);
      Object(_animScreenTop__WEBPACK_IMPORTED_MODULE_5__["animJumpText"])(Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl(`.intro__title`).$el, {
        property: `transform`,
        direction: 500,
        timeFunction: `ease`,
        classRunAnim: `active`,
    ...
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["GAME"]}`]: (el) => {
      Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl(`.chat__footer .form__field`).addClass(`form__field-anim`);
      const animTimerGame = new _animScreenGame__WEBPACK_IMPORTED_MODULE_7__["AnimTimerGame"](Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl(`.game__counter`).$el);
    },
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["STORY"]}`]: (el, nameTheme = `dark-purple`) => {
      Object(_animScreenStoty__WEBPACK_IMPORTED_MODULE_8__["addColorTheme"])(nameTheme);
      Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl(`.slider`).addClass(`anim-pagination`);
    },
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["RULES"]}`]: (el) => {
      Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl(`.rules`).addClass(`rules--anim`);
    },
    animHeader: () => {
      Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(document.body).addClass(`body--anim`);
    },
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["RESULT1"]}`]: (el) => {
      Object(_animScreenResult__WEBPACK_IMPORTED_MODULE_4__["animTextSvg"])(Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl(`#victory1`).$el);
      beginAnimSVG(el, `#animTextV1`);
      const scene = new _animCanvas_SceneSeaCalf__WEBPACK_IMPORTED_MODULE_2__["Scene2DSeaCalf"]();
      scene.start();
    },
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["RESULT2"]}`]: (el) => {
      Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl(`.result__images`).addClass(`anim-app-img`);
      Object(_animScreenResult__WEBPACK_IMPORTED_MODULE_4__["animTextSvg"])(Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl(`#victory2`).$el);
      beginAnimSVG(el, `#animTextV2`);
    },
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["RESULT3"]}`]: (el) => {
      Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl(`.result__button`).addClass(`anim-button`);
      Object(_animScreenResult__WEBPACK_IMPORTED_MODULE_4__["animJumpTextSvg"])(Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl(`#losing`).$el);
      Object(_animScreenResult__WEBPACK_IMPORTED_MODULE_4__["animTextSvg"])(Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl(`#losing`).$el);
      setTimeout(()=>{
        beginAnimSVG(el, `#animTextL`);

      }, 500);

      const scene = new _animCanvas_SceneCrocodile__WEBPACK_IMPORTED_MODULE_3__["Scene2DCrocodile"]();
      scene.start();
    },
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["PRIZES"]}`]: (el) => {
      let countPrizes = Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl(`.prizes__desc b`);

      beginAnimSVG(el, `#mainAnim`);
      setTimeout(() => {
        Object(_animScreenPrizes__WEBPACK_IMPORTED_MODULE_6__["animCountPrizes"])(countPrizes[0].$el);
      }, 1400);
      ...
      setTimeout(() => {
        Object(_animScreenPrizes__WEBPACK_IMPORTED_MODULE_6__["animCountPrizes"])(countPrizes[1].$el);
      }, 3000);
      ...
      setTimeout(() => {
        Object(_animScreenPrizes__WEBPACK_IMPORTED_MODULE_6__["animCountPrizes"])(countPrizes[2].$el);
      }, 4700);
    },
  };
  ...
  document.body.addEventListener(`screenChanged`, (e) => {
    ...
    if (e.detail.screenName !== _screenNames__WEBPACK_IMPORTED_MODULE_1__["STORY"]) {
      Object(_animScreenStoty__WEBPACK_IMPORTED_MODULE_8__["addColorTheme"])(`base`);
    }
  });
...
const animHiddenScreen = (screenName) => {
  const animFooter = (nameClass) => {
    Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(document.body).addClass(nameClass);
    setTimeout(() => {
      Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(document.body).removeClass(nameClass);
    }, 600);
  };
  const handlers = {
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["PRIZES"]}`]: () => {
      animFooter(`anim--footer__prizes`);
    },
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["RULES"]}`]: () => {
...
/***/ "./source/js/modules/animation/animCanvas/Animation.js":
/*!*************************************************************!*\
  !*** ./source/js/modules/animation/animCanvas/Animation.js ***!
  \*************************************************************/
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./source/js/modules/animation/utils.js");
...
class Animation {
  constructor(options) {
    ...
    this.easing = options.easing || _utils__WEBPACK_IMPORTED_MODULE_0__["ease"].linear;
...
/***/ "./source/js/modules/animation/animCanvas/Scene2d.js":
/*!***********************************************************!*\
  !*** ./source/js/modules/animation/animCanvas/Scene2d.js ***!
  \***********************************************************/
...
/* harmony import */ var _Animation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Animation */ "./source/js/modules/animation/animCanvas/Animation.js");
...
/***/ "./source/js/modules/animation/animCanvas/SceneCrocodile.js":
/*!******************************************************************!*\
  !*** ./source/js/modules/animation/animCanvas/SceneCrocodile.js ***!
  \******************************************************************/
...
/* harmony import */ var _Scene2d__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Scene2d */ "./source/js/modules/animation/animCanvas/Scene2d.js");
/* harmony import */ var _Animation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Animation */ "./source/js/modules/animation/animCanvas/Animation.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils */ "./source/js/modules/animation/utils.js");
...
class Scene2DCrocodile extends _Scene2d__WEBPACK_IMPORTED_MODULE_0__["Scene2D"] {
  constructor() {
  ...
  animKey() {
    this.animations.push(
        new _Animation__WEBPACK_IMPORTED_MODULE_1__["Animation"]({
          f: (progress) => {
        ...
        new _Animation__WEBPACK_IMPORTED_MODULE_1__["Animation"](
            {
              ...
              dur: 400,
              del: 950,
              easing: _utils__WEBPACK_IMPORTED_MODULE_2__["ease"].inQuad
            }
        )
    );
  }
...
/***/ "./source/js/modules/animation/animCanvas/SceneSeaCalf.js":
/*!****************************************************************!*\
  !*** ./source/js/modules/animation/animCanvas/SceneSeaCalf.js ***!
  \****************************************************************/
...
class Scene2DSeaCalf extends _Scene2d__WEBPACK_IMPORTED_MODULE_0__["Scene2D"] {
  constructor() {
  ...
  animSeaCalf() {
    ...
    const anim = new _Animation__WEBPACK_IMPORTED_MODULE_1__["Animation"]({
      f: (progress) => {
      ...
      easing: _utils__WEBPACK_IMPORTED_MODULE_2__["ease"].outElastic,
      dur: 2000,
      del: 200
    });
...
/***/ "./source/js/modules/animation/animScreenGame.js":
/*!*******************************************************!*\
  !*** ./source/js/modules/animation/animScreenGame.js ***!
  \*******************************************************/
/*! exports provided: AnimTimerGame */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnimTimerGame", function() { return AnimTimerGame; });
...
/***/ "./source/js/modules/animation/animScreenPrizes.js":
/*!*********************************************************!*\
  !*** ./source/js/modules/animation/animScreenPrizes.js ***!
  \*********************************************************/
/*! exports provided: animCountPrizes, animJumpScreen */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animCountPrizes", function() { return animCountPrizes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animJumpScreen", function() { return animJumpScreen; });
/* harmony import */ var _screenNames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../screenNames */ "./source/js/screenNames.js");
/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../dom */ "./source/js/dom.js");




const animJumpScreen = (screenName) => {
  if (screenName !== _screenNames__WEBPACK_IMPORTED_MODULE_0__["PRIZES"]) {
    return;
  }
  return new Promise((resolve) => {
    let elJumpScreen = Object(_dom__WEBPACK_IMPORTED_MODULE_1__["$"])(document)
      .findEl(`.jump-screen`)
...
/***/ "./source/js/modules/animation/animScreenResult.js":
/*!*********************************************************!*\
  !*** ./source/js/modules/animation/animScreenResult.js ***!
  \*********************************************************/
/*! exports provided: animJumpTextSvg, animTextSvg */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animJumpTextSvg", function() { return animJumpTextSvg; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animTextSvg", function() { return animTextSvg; });
...
/***/ "./source/js/modules/animation/animScreenStoty.js":
/*!********************************************************!*\
  !*** ./source/js/modules/animation/animScreenStoty.js ***!
  \********************************************************/
/*! exports provided: addColorTheme */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addColorTheme", function() { return addColorTheme; });
/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../dom */ "./source/js/dom.js");


const addColorTheme = (nameTheme) => {
  const namesTheme = [`base`, `dark-purple`, `dark-blue`, `light-blue`];
  if (!namesTheme.includes(nameTheme)) {
    return;
  }
  const el = Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(document).findEl(`body`);
...
/***/ "./source/js/modules/animation/animScreenTop.js":
/*!******************************************************!*\
  !*** ./source/js/modules/animation/animScreenTop.js ***!
  \******************************************************/
/*! exports provided: animJumpText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animJumpText", function() { return animJumpText; });
...
/***/ "./source/js/modules/animation/utils.js":
/*!**********************************************!*\
  !*** ./source/js/modules/animation/utils.js ***!
  \**********************************************/
...
/* harmony import */ var _animation_animScreenPrizes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animation/animScreenPrizes */ "./source/js/modules/animation/animScreenPrizes.js");
/* harmony import */ var _animation_anim__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./animation/anim */ "./source/js/modules/animation/anim.js");
...
class FullPageScroll {
  ...
  async changeVisibilityDisplay() {
    await Object(_animation_anim__WEBPACK_IMPORTED_MODULE_2__["animHiddenScreen"])(this.screenElements[this.prevActiveScreen].id);
    await Object(_animation_animScreenPrizes__WEBPACK_IMPORTED_MODULE_1__["animJumpScreen"])(this.screenElements[this.activeScreen].id);
...
/* harmony import */ var _animation_animScreenStoty__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animation/animScreenStoty */ "./source/js/modules/animation/animScreenStoty.js");
        ...
        on: {
          slideChange: () => {
            if (
              ...
              sliderContainer.style.backgroundImage = `url('img/slide1.jpg'), linear-gradient(180deg, rgba(83, 65, 118, 0) 0%, #523E75 16.85%)`;
              Object(_animation_animScreenStoty__WEBPACK_IMPORTED_MODULE_1__["addColorTheme"])(`dark-purple`);
            } else if (
              ...
              Object(_animation_animScreenStoty__WEBPACK_IMPORTED_MODULE_1__["addColorTheme"])(`dark-blue`);
            } else if (
              ...
              Object(_animation_animScreenStoty__WEBPACK_IMPORTED_MODULE_1__["addColorTheme"])(`light-blue`);
            } else if (
...
/***/ "./source/js/screenNames.js":
/*!**********************************!*\
  !*** ./source/js/screenNames.js ***!
  \**********************************/
/*! exports provided: PRIZES, TOP, GAME, RESULT1, RESULT2, RESULT3, RULES, STORY */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RESULT2", function() { return RESULT2; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RESULT3", function() { return RESULT3; });
...
/* harmony import */ var _modules_animation_anim__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/animation/anim */ "./source/js/modules/animation/anim.js");
// modules
...
Object(_modules_animation_anim__WEBPACK_IMPORTED_MODULE_9__["animChangeScreen"])();
