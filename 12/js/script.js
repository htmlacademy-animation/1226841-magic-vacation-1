...
const $ = (el) => {return new Dom(el)}



/***/ }),

/***/ "./source/js/modules/anim.js":
/*!***********************************!*\
  !*** ./source/js/modules/anim.js ***!
  \***********************************/
/*! exports provided: animChangeScreen, animHiddenScreen, addColorTheme, animJumpScreen */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const animChangeScreen = () => {
  let handlers = {
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["TOP"]}`]: (el) => {
      ...
      animJumpText(Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl('.intro__title').$el, {
        property: 'transform',
        direction: 500,
        timeFunction: 'ease',
        classRunAnim: 'active'
    ...
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["GAME"]}`]: (el) => {
      ...
      animTimerGame( Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl('.game__counter').$el)
    },
    ...
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["RESULT1"]}`]: (el) => {
     animTextSvg(Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl('#victory1').$el)
    ...
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["RESULT2"]}`]: (el) => {
      ...
      animTextSvg(Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl('#victory2').$el)
    ...
    [`anim${_screenNames__WEBPACK_IMPORTED_MODULE_1__["RESULT3"]}`]: (el) => {
      ...
      animJumpTextSvg(Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl('#losing').$el)
      animTextSvg(Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(el).findEl('#losing').$el)
...
const animJumpScreen = (screenName) => {
  if (screenName !== _screenNames__WEBPACK_IMPORTED_MODULE_1__["PRIZES"])  return
  return new Promise((resolve, reject) => {
    let elJumpScreen = Object(_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(document).findEl('.jump-screen').addClass('jump-screen--anim')
...
/* harmony import */ var _anim__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./anim */ "./source/js/modules/anim.js");
...
class FullPageScroll {
  ...
  async changeVisibilityDisplay() {
    await Object(_anim__WEBPACK_IMPORTED_MODULE_1__["animHiddenScreen"])(this.screenElements[this.prevActiveScreen].id)
    await Object(_anim__WEBPACK_IMPORTED_MODULE_1__["animJumpScreen"])(this.screenElements[this.activeScreen].id);
        ...
        on: {
          slideChange: () => {
            if (storySlider.activeIndex === 0 || storySlider.activeIndex === 1) {
              sliderContainer.style.backgroundImage = `url("img/slide1.jpg"), linear-gradient(180deg, rgba(83, 65, 118, 0) 0%, #523E75 16.85%)`;
              Object(_anim__WEBPACK_IMPORTED_MODULE_1__["addColorTheme"])('dark-purple')
              ...
              Object(_anim__WEBPACK_IMPORTED_MODULE_1__["addColorTheme"])('dark-blue')
              ...
              Object(_anim__WEBPACK_IMPORTED_MODULE_1__["addColorTheme"])('light-blue')
...
/* harmony import */ var _modules_anim__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/anim */ "./source/js/modules/anim.js");
// modules
...
Object(_modules_anim__WEBPACK_IMPORTED_MODULE_9__["animChangeScreen"])();
